...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/17 20:00:12 by pjedrycz          #+#    #+#             */
/*   Updated: 2024/07/17 20:29:30 by pjedrycz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Gets the possition of the element with
//lowest index on the stack.
...
void	get_target_position(t_stack **a, t_stack **b)
{
	...
	while (tmp_b)
	{
		trgt_pos = get_target(a, tmp_b->index, INT_MAX, trgt_pos);
		tmp_b->target_pos = trgt_pos;
		tmp_b = tmp_b->next;
	}
}
